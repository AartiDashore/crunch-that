...
public class IndianNonVegActivity extends Activity {
	Button b1,b2;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_indian_non_veg);
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(IndianNonVegActivity.this,CrunchActivity.class);
				startActivity(i);
			}
		});
		b2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(IndianNonVegActivity.this,"You Selected: "+String.valueOf(sb)+"\n",Toast.LENGTH_LONG).show();
			}
		});
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.indian_non_veg, menu);
		return true;
	}
