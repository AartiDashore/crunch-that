...
public class IndianVegActivity extends Activity {
Button b1,b2;
...
StringBuffer sb;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_indian_veg);
		...
		b1.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i=new Intent(IndianVegActivity.this,CrunchActivity.class);
				startActivity(i);
		...
		b2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(IndianVegActivity.this,"You Selected: "+String.valueOf(sb)+"\n",Toast.LENGTH_LONG).show();
			}
		});
	}
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.indian_veg, menu);
		return true;
	}
