...
public class ChineseVegActivity extends Activity {
	Button cvam,cvo;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_chinese_veg);
		cvam=(Button) findViewById(R.id.button1);
		cvo=(Button) findViewById(R.id.button2);
		...
		cvam.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i=new Intent(ChineseVegActivity.this,CrunchActivity.class);
				startActivity(i);
				
			}
		});
cvo.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Toast.makeText(ChineseVegActivity.this,"You Selected: "+String.valueOf(sb)+"\n",Toast.LENGTH_LONG).show();
			}
		});
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.chinese_veg, menu);
		return true;
	}
